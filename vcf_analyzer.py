...
def plot_metrics_vs_variants(test_metrics_list, window_stats, output_dir):
    ...
    try:
        ...
        # Create subplots
        plt.subplot(3, 1, 1)
        plt.scatter(num_variants, macro_f1, c='blue', label='Macro F1', alpha=0.6)
        plt.scatter(num_variants, weighted_f1, c='red', label='Weighted F1', alpha=0.6)
        plt.title('F1 Scores vs Number of Variants')
        ...
        plt.subplot(3, 1, 2)
        plt.scatter(num_variants, macro_precision, c='blue', label='Macro Precision', alpha=0.6)
        plt.scatter(num_variants, weighted_precision, c='red', label='Weighted Precision', alpha=0.6)
        plt.title('Precision Scores vs Number of Variants')
        plt.xlabel('Number of Variants')
        plt.ylabel('Precision')
        plt.legend()
        plt.grid(True)
        ...
        plt.subplot(3, 1, 3)
        plt.scatter(num_variants, macro_recall, c='blue', label='Macro Recall', alpha=0.6)
        plt.scatter(num_variants, weighted_recall, c='red', label='Weighted Recall', alpha=0.6)
        plt.title('Recall Scores vs Number of Variants')
        plt.xlabel('Number of Variants')
        plt.ylabel('Recall')
        plt.legend()
        plt.grid(True)
